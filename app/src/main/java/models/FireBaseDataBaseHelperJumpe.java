...
public class FireBaseDataBaseHelperJumpe {
    ...
    public FireBaseDataBaseHelperJumpe() {
    ...
    public void readWork(final FireBaseDataBaseHelperJumpe.DataStatus dataStatus){
        MreferenceWork.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot keyNode:dataSnapshot.getChildren()){
                    ...
                    if (workOut.getEqpName().equals("Jumprope")) {
