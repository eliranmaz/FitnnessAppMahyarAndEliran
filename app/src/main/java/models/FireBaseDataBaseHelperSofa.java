...
public class FireBaseDataBaseHelperSofa {
    ...
    public FireBaseDataBaseHelperSofa() {
    ...
    public void readWork(final FireBaseDataBaseHelperSofa.DataStatus dataStatus){
        MreferenceWork.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot keyNode:dataSnapshot.getChildren()){
                    ...
                    if (workOut.getEqpName().equals("Fitness sofa")) {
