...
public class FireBaseDataBaseHelperStep {
    ...
    public FireBaseDataBaseHelperStep() {
    ...
    public void readWork(final FireBaseDataBaseHelperStep.DataStatus dataStatus){
        MreferenceWork.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot keyNode:dataSnapshot.getChildren()){
                    ...
                    if (workOut.getEqpName().equals("step")) {
