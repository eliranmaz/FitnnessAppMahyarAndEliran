...
public class FireBaseDataBaseHelperMats {
    ...
    public FireBaseDataBaseHelperMats() {
    ...
    public void readWork(final FireBaseDataBaseHelperMats.DataStatus dataStatus){
        MreferenceWork.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot keyNode:dataSnapshot.getChildren()){
                    ...
                    if (workOut.getEqpName().equals("mattress")) {
